...
// export const onRegisterLogin = ({username , password}) => {
//     return (dispatch)  =>{
...
//                 dispatch({ type : REGISTER_LOGIN, payload : username})
//             }
//             else {
        ...
        axios.get('http://localhost:1995/users',{
            ...
            if(res.data.length > 0) {
                dispatch({ 
                    ...
                    payload: { email: res.data[0].email, username : res.data[0].username , id : res.data[0].id } 
                })
            }
        })
    }
...
//         dispatch({type : AUTH_LOADING}) // Loading
//         if(username === '' || email === '' || phone === '' || password === ''){
//             dispatch({ type : AUTH_SYSTEM_ERROR , payload : 'Semua Form Di atas Harus di isi'})
//         }
//         else{
//             axios.get('http://localhost:1995/users', {
//                 params : {
...
//                     }).then((res) =>{
//                         console.log(res)
//                         dispatch({ type : USER_LOGIN_SUCCES, payload : username})
//                     }).catch((err) =>{
//                         console.log(err)
//                         dispatch({ type : AUTH_SYSTEM_ERROR , payload : 'System Error' })
//                     })
